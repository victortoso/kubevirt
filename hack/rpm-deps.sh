...
LIBVIRT_VERSION=${LIBVIRT_VERSION:-0:10.10.0-9.el9}
QEMU_VERSION=${QEMU_VERSION:-17:9.1.0-18.el9}
SEABIOS_VERSION=${SEABIOS_VERSION:-0:1.16.3-4.el9}
EDK2_VERSION=${EDK2_VERSION:-0:20241117-3.el9}
LIBGUESTFS_VERSION=${LIBGUESTFS_VERSION:-1:1.54.0-6.el9}
GUESTFSTOOLS_VERSION=${GUESTFSTOOLS_VERSION:-0:1.52.2-4.el9}
PASST_VERSION=${PASST_VERSION:-0:0^20250320.g32f6212-1.el9}
