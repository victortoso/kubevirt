...
var (
	...
	USBDEVICESCONFIG                 = "usbdevicesconfigs." + usbv1alpha1.SchemeGroupVersion.Group
	PreserveUnknownFieldsFalse       = false
)
...
func NewUSBDevicesConfigCrd() (*extv1.CustomResourceDefinition, error) {
	crd := newBlankCrd()

	crd.ObjectMeta.Name = USBDEVICESCONFIG
	crd.Spec = extv1.CustomResourceDefinitionSpec{
		...
		Names: extv1.CustomResourceDefinitionNames{
			Plural:     usbv1alpha1.ResourceUSBDevicesConfigPlural,
			Singular:   usbv1alpha1.ResourceUSBDevicesConfigSingular,
			ShortNames: []string{usbv1alpha1.ResourceUSBDevicesConfigSingular, usbv1alpha1.ResourceUSBDevicesConfigPlural},
