...
var _ = Describe("VirtualMachineInstance", func() {
	...
	var usbDevicesConfigInformer cache.SharedIndexInformer
	...
	BeforeEach(func() {
		...
		usbDevicesConfigInformer, _ = testutils.NewFakeInformerFor(&usbv1alpha1.USBDevicesConfig{})
